...
public class ImageUtils {
    ...
    public static boolean saveBitmap2file(Bitmap bmp) {
        ...
        try {
            ...
            // 在SDcard创建文件夹及文件
            File bitmapFile = new File(SDCardRoot.getPath() + ConstantUtils.AVATAR_FILE_PATH);
            bitmapFile.getParentFile().mkdirs();// 创建文件夹
            stream = new FileOutputStream(SDCardRoot.getPath() + ConstantUtils.AVATAR_FILE_PATH);// "/sdcard/"
