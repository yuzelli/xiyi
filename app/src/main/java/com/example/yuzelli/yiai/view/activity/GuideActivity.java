...
import com.example.yuzelli.yiai.adapter.GuideViewAdapter;
    ...
    private void initoper() {
        ...
        tv_immediatelyEnter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                SharedPreferences.Editor editor = getSharedPreferences(ConstantUtils.FIRST_LOGIN_SP,MODE_PRIVATE).edit();
                editor.putBoolean(ConstantUtils.FIRST_LOGIN_KEY, false);
                editor.commit();
